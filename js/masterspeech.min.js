...
if(but.src.endsWith("mic_off.png")){console.log("here")
but.setAttribute("src","images/mic_on.gif");start_recording(function(final_transcript,interim_transcript){console.log(final_transcript+interim_transcript);},revmod);}else{but.setAttribute("src","images/mic_off.png");processing();stop_recording();}}
